...
class TemporalTransFusionDetector(MVXTwoStageDetector):
    """Base class of Multi-modality VoxelNet."""

    def __init__(self, **kwargs):
        super(TemporalTransFusionDetector, self).__init__(**kwargs)
    ...
    def init_weights(self, pretrained=None):
        ...
        super(TemporalTransFusionDetector, self).init_weights(pretrained)
