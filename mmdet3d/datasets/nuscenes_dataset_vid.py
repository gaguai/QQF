...
class NuScenesDatasetVID(Custom3DDataset):
    r"""NuScenes Dataset.
    ...
    def get_cat_ids(self, idx):
        ...
        if self.use_valid_flag:
            mask = info[0]['valid_flag']
            gt_names = set(info[0]['gt_names'][mask])
        else:
            gt_names = set(info[0]['gt_names'])
    ...
    def load_annotations(self, ann_file):
        ...
        data_infos = list(sorted(data['infos'], key=lambda e: e[0]['timestamp']))
    ...
    def get_data_info(self, index):
        ...
        """
        # info[0] : current, info[1] : previous
        ...
        for info in infos:
            ...
            input_dict['scene_idx'].append(info['scene_token'])
